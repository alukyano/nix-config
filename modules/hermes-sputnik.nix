{config, pkgs, lib, pkgs-unstable, inputs, username, ...}: {  
  ...
  services.hermes-agent = {
    ...
    settings.model.base_url = "http://192.168.55.73:9148/v1";
  ...
  #   };
    ...
    custom_providers = {
      name = [ "custom" ];
      base_url = "http://192.168.55.73:9148/v1";
    ...
    environment = {
      ...
      OPENAI_BASE_URL = "http://192.168.55.73:9148";
      TELEGRAM_PROXY = "socks5://192.168.55.73:4444";
      TELEGRAM_BOT_TOKEN="";
...
users.users.hermes.extraGroups = [ "docker" "hermes" ];
